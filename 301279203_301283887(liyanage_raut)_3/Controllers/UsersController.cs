...
namespace _301279203_301283887_liyanage_raut__3.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Dashboard()
        {
            ...
            return RedirectToAction("Dashboard","Movies");
        }
        ...
        {
            if (model.Username != "" || model.UserPassword != "")
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("UserId,FullName,Username,UserPassword")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FullName,Username,UserPassword")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
